# MINISHELL
minishell is a Unix-like shell written in [C](https://en.wikipedia.org/wiki/C_(programming_language)) language, this shell was inspired by [Bash](https://en.wikipedia.org/wiki/Bash_(Unix_shell)).
